    ...
    public function create_or_update(Request $request, $id)
    {
        ...
        //
          $biodata = \App\Biodata::updateOrCreate([
            ...
            'tanggal_lahir' => date('yy-m-d',strtotime($request->get('tanggal_lahir'))),
            'alamat' => $request->get('alamat'),
            'agama' => $request->get('agama'),
            'nuptk' => $request->get('nuptk'),
            'no_sk_cpns' => $request->get('no_sk_cpns'),
            'tmt_cpns' => date('yy-m-d',strtotime($request->get('tmt_cpns'))),
            'tmt_pns' => date('yy-m-d',strtotime($request->get('tmt_pns'))),
