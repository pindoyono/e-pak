            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="col-12 text-right">
                        <a href="{{route('berkas.bukti', Crypt::encrypt($berkas->dupak_id))}}" class="btn btn-success">List Bukti Fisik <div class="ripple-container"></div></a>
                    </div>
                    @if(count($errors) > 0)
                            ...
                            <div class="col-md-8">
                                <div class="col-md-12">
                                    ...
                                    @if(!empty($kegiatans))
                                        ...
                                        <option {{ $berkas->nama == $kegiatan->id ? "selected" : ""}} value="{{$kegiatan->id}}">{{$kegiatan->kegiatan}}</option>
                                        @endforeach
                                    @endif
                                    </select>
                                </div>
