            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="col-12 text-right">
                        <a href="{{route('lampirans.index')}}" class="btn btn-success">List Jabatan <div class="ripple-container"></div></a>
                    </div>
                    @if(count($errors) > 0)
                    ...
                    @endif
                    <form enctype="multipart/form-data" class="form-horizontal"  action="{{route('lampirans.update', [$data->id])}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label"></label>
                                    <textarea name="diskripsi" id="diskripsi" cols="100" rows="10" required="true"> {{ $data->diskripsi}} </textarea>
                                    <span class="material-input"></span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label"></label>
                                    <textarea name="saran" id="saran" cols="100" rows="10" required="true"> {{ $data->saran}}  </textarea>
                                    <span class="material-input"></span>
                                </div>
                            </div>
                        </div>
