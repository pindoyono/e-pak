                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Lama</td>
                                    <td colspan=2>{{ masakerja($biodatas->tmt_cpns,$biodatas->tmt_pns).' '. masakerja1($biodatas->tmt_cpns,$biodatas->tmt_pns) }}</td>
                                </tr>
                                <tr>
                                    <td>Baru</td>
                                    <td colspan=2>{{ masakerja($biodatas->tmt_cpns,$now).' '. masakerja1($biodatas->tmt_cpns,$now) }}</td>
                                </tr>
                                <tr>
                                    <td width="5%"> 10</td>
